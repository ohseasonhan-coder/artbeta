...
export async function POST(request: Request) {
  ...
  try {
    ...
    gallerySlides.forEach((slide, index) => {
      ...
      slide.eyebrow = "ON STAGE";
      slide.title = index ? "무대 밖에서도 이어지는 현장감" : "한눈에 확인하는 공연의 현장감";
      slide.body = "";
