...
const extractionSchema = z.object({
  ...
  programConfigurations: z.array(z.string()),
...
export async function POST(request: Request) {
  ...
  try {
    ...
    profile.repertoire.forEach((value) => items.push(makeItem("repertoire", "공연 가능 레퍼토리", value, 0.84)));
